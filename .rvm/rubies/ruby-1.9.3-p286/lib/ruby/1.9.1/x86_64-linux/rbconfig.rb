...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--prefix=$(prefix)' '--enable-shared' '--enable-load-relative' '--sysconfdir=/etc' 'CFLAGS=-I$(prefix)/include' 'LDFLAGS=-L$(prefix)/lib'"
  ...
  CONFIG["LDFLAGS"] = "-L. -L$(prefix)/lib -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-I$(prefix)/include -fPIC"
  CONFIG["CC"] = "gcc"
